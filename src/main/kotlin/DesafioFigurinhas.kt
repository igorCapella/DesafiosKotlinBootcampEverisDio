  /*
Resumo do Desafio 5 de Solucionando Problemas em Kotlin
  . Ricardo e Vicente;
...
fun main() {
    ...
    val listaMdc = mutableListOf<Int>()

	// Utilizando valor de entrada do readLine() que informa a quantidade de casos de teste.
